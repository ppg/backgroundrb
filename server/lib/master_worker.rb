...
module BackgrounDRb
  ...
  class MasterWorker
    ...
    def worker_methods worker_name_key
      # PPG - If a worker silently fails then live_workers[worker_name_key] is nil;
      #  we can check for that and either auto-restart it, or do something better than throw an
      #  error up here
